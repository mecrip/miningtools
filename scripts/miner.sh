...
while true; do
    ...
    echo `date` $MINER >> /home/mirko/logs/currentminer.log
    /home/mirko/miner/dstm/current/zm --server europe.equihash-hub.miningpoolhub.com --port 12023 --user $WORKER --pass $PASSWORD --noreconnect --telemetry=0.0.0.0:2222 --temp-target 80 >>  /home/mirko/logs/ccminer.log 2>&1
    ...
    echo `date` $MINER >> /home/mirko/logs/currentminer.log
    /usr/local/bin/ccminer -r 0 -a neoscrypt -o stratum+tcp://hub.miningpoolhub.com:12012           -u $WORKER -p $PASSWORD  -b 0.0.0.0:4068 --intensity 22 --max-temp=80 >> /home/mirko/logs/ccminer.log 2>&1
    ...
    echo `date` $MINER >> /home/mirko/logs/currentminer.log
    /usr/local/bin/ccminer -r 0 -a lyra2v2 -o stratum+tcp://hub.miningpoolhub.com:12018             -u $WORKER -p $PASSWORD  -b 0.0.0.0:4068 --intensity=22 --max-temp=80 >> /home/mirko/logs/ccminer.log 2>&1
